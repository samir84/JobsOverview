package com.hs.eai.jobsoverview.spring;
...
@Configuration
@EnableWebMvc
@ComponentScan("com.hs.eai.jobsoverview")
@PropertySource("file:henryschein/JobsOverviewWS.properties")
...
public class WebAppConfig {
	...
	private static final String JDBC_RESOURCE_JNDI_NAME="jdbcResourceJndiName";//jdbc/eaijobs	
