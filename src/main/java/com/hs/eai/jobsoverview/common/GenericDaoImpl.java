package com.hs.eai.jobsoverview.common;
...
public abstract class GenericDaoImpl<T> implements GenericDao<T> {
	...
	@Transactional
	public List<T> Pagination(int page, int maxResult , String prop) {
		...
		final StringBuffer queryString = new StringBuffer("SELECT o from ");
		queryString.append(type.getSimpleName()).append(" o ").append(" ").append(" order by o.").append(prop);
